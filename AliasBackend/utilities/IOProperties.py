...
english_cal_rf_model_filename = os.path.join(os.environ['HOME'],'repo/AliasSensor/AliasBackend/models/eng_cal_rf_finalized_model.sav')
swedish_cal_rf_model_filename = os.path.join(os.environ['HOME'], 'repo/AliasSensor/AliasBackend/models/swe_cal_rf_finalized_model.sav')
